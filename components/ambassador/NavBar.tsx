				...
				>
					<nav className="items-center flex justify-between w-full max-w-[866px] xl:max-w-[923px] xl1:max-w-[975px] 2xl:max-w-screen-2xl mx-auto lg:justify-start lg:space-x-10">
						...
						<div className="flex items-center justify-end lg:flex-1 lg:w-0 flex-row space-x-[47px] cursor-pointer">
							<button
								className={`text-champagne-pink rounded-full flex items-center justify-center text-base font-black text-[10px] lg1:text-[13px] 2xl:text-[20px]`}
							...
							<Link href="/#">
								<div
									...
									`}
								>
									<p className="my-auto">Apply now</p>
								</div>
							</Link>
							<svg
