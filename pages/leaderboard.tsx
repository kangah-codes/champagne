							...
							<div className="flex flex-col justify-between space-y-5">
								...
								<div className="grid grid-cols-4 xl:grid-cols-5 gap-[4.6px] xl:gap-5 justify-between w-full pt-5 max-w-3xl mx-auto">
									...
									>
										...
										<span className="text-[13px] leading-[13px] lg1:text-[15px] lg1:leading-[15px] 2xl:text-[20px] font-anton 2xl:leading-[20px] flex truncate">
											Share{" "}
											<span className="hidden lg1:block ml-1">
												{" "}
												with friends
											</span>
										</span>
