...
function Hero({
	...
	return (
		<div className="w-full bg-white flex overflow-hidden px-4 flex-col">
			<div className="w-full max-w-5xl xl:max-w-7xl mx-auto flex items-center justify-center">
				<div className="mx-auto py-[5rem]">
			...
			<div className="w-full max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto flex items-center justify-center">
				...
				<div className="mx-auto py-[5rem]"></div> */}
					<div className="relative w-full max-w-5xl xl:max-w-7xl mx-auto flex items-center justify-center">
							...
							.map((item, i) =>
								i <= 1 ? (
									...
									>
										...
										<div
											className={`
											border-[4px] xl:border-[7px] text-white self-end w-[98%] border-black 
											rounded-[43px] ${
												i === 0
													? "bg-gradient-to-br from-champagne-pink relative via-champagne-light-blue to-champagne-green"
													: "bg-champagne-pink"
											}
											p-5 xl:p-10 z-[20] flex flex-col justify-between h-full
										`}
										>
											...
											<div className="flex flex-col max-w-md mt-8 xl:mt-0">
												...
												<h1 className="text-[61px] leading-[61px] xl:text-[71px] font-anton xl:leading-[80px] w-full line-clamp-2">
													{item[0]}
												</h1>
											</div>
